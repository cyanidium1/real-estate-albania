  ...
  const content = {
    ...
    pl: {
      ...
      description: "Kup nieruchomość nad morzem i uzyskaj pozwolenie na zamieszkanie!",
    ...
    ru: {
      ...
      description: "Приобретите недвижимость у моря и получите Вид на жительство!",
  ...
  function updateContent(language) {
    ...
    itemsList.innerHTML = langContent.items.map(item => `<li>${item}</li>`).join('');
  }
...
const langContent2 = content2[lang];
  document.getElementById("heading") = langContent2.heading 
  document.getElementById("list")= langContent2.items ;
    ...
    listElement.innerHTML = items
      .map((item, index) => {
        return `<li id="item${index + 1}" class="w-fit mb-16 
